...
var TAMS_VOLUMEN1 = []int{12500, 25000, 50000, 100000, 200000, 400000}
...
func ejecutarPruebaVolumenDicc(b *testing.B, n int) {
	dic := TDADiccionario.CrearHash[string, int]()
...
func BenchmarkDiccionarioDicc(b *testing.B) {
...
func ejecutarPruebasVolumenIteradorDicc(b *testing.B, n int) {
	dic := TDADiccionario.CrearHash[string, *int]()
...
func BenchmarkIteradorDicc(b *testing.B) {
...
func TestVolumenIteradorCorteDicc(t *testing.T) {
